...
def getmyxls():#
    ...
    listofxlsx=["Girl on the train(done).xlsx", "NewHH.xlsx","Rogue Lawyer(done).xlsx","Secret Garden (done).xlsx","Set a watchman (done).xlsx","Lights we cannot see (done).xlsx"]
    ...
    #listofxlsxlaptops=["AcerChromebook.xlsx","AsusX551.xlsx","HPStream.xlsx","ToshibaChromebook.xlsx","ToshibaSatellite.xlsx","Zenbook.xlsx"]
    listwetrulywant=[]
    count=0

    for xl in listofxlsx:
        print "xlsx=", xl
...
def addaddfeatures(vec, addf, space):
    ...
    bookformats=["Unidentified","Paperback","Kindle Edition","Hardcover","Audible Audio Edition","Audio CD"]
    phoneformats=["Unidentified","16 GB","32 GB","64 GB"]
    laptopformats=["Unidentified","ASUS Laptop","Personal Computers","Laptop","Windows 10","Windows 8"]
    vec[space["FORMAT"]]=bookformats.index(addf[4])
    return vec
