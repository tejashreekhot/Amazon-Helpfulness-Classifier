...
def getNRCLexicon():
    """
    Populates dictionaries from the NRC emotion files...
    """
    path = '/Users/mam/CORE/RESEARCH/emotion/RESOURCES/NRC-SPLIT'
    anger={}
    anticipation={}
    ...
    return anger, anticipation, disgust, fear, happiness, negative, positive, sadness, surprise, trust
#anger, anticipation, disgust, fear, joy, negative, positive, sadness, surprise, trust=getNRCLexicon()
#print "anger:", len(anger), "\nanticipation:", len(anticipation), "\ndisgust:", len(disgust), "\nfear:", len(fear), "\njoy:", len(joy),
#print "negative:", len(negative), "\npositive:", len(positive), "\nsadness:", len(sadness), "\nsurprise:", len(surprise), "\ntrust:", len(trust)

def addEmotionLexiconFeatures(vec, sent, space):
    """
    """
...
def getOneHotVectors(ids, labels, vectors, space):
    ...
    for triple in triples:
        ...
        vec=np.zeros((len(space))) # ; second argument is dimensionality of the array, which is 1
        for w in dataPoint:
            try:
                vec[space[w]] = 1
            except:
...
<<<<<<< HEAD
    print getSAIMAThreeColumnFormat()
=======
    #print(saimaDataTuples)
>>>>>>> origin/master
